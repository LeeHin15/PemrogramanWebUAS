  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">DAFTAR HARGA KAMAR </span>
      </a>
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="py-2 text-dark text-decoration-none" href="#">Harga</a>
      </nav>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">Rp.500.000<small class="text-muted fw-light">/Hari</small></h1>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">Rp.800.00<small class="text-muted fw-light">/hari</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
            </ul>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">Rp 1.500.000<small class="text-muted fw-light">/hari</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
            </ul>
            <button type="button" class="w-100 btn btn-lg btn-primary">book now</button>
          </div>
